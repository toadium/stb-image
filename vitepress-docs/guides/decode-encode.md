...
<CardGrid :columns="3">
  <Card href="/api/core-api" title="加载" description="load_from_path / load_from_bytes" icon="📂" />
  <Card href="/api/core-api" title="写入" description="write_png/bmp/tga/jpeg/hdr" icon="💾" />
  <Card href="/api/lib-api" title="自动检测" description="decode_any / load_from_bytes_auto" icon="🔍" />
</CardGrid>
...
<ActionButton href="/api/core-api" text="Core API" type="brand" />
<ActionButton href="/api/lib-api" text="Pure API" type="alt" />
<ActionButton href="/concepts/format-detection" text="格式检测" type="subtle" />

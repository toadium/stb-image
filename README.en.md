...
[![Tests](https://img.shields.io/badge/tests-1611-brightgreen)]()
[![Coverage](https://img.shields.io/badge/coverage-90.4%25-brightgreen)]()
[![Functions](https://img.shields.io/badge/API-601%20functions%20%2B%201%20const%20%2B%2047%20types-blueviolet)]()
...
| | 🟢 | **601 APIs** | From basic I/O to FFT, Canny, watershed, SLIC, ORB, SIFT, SIFT matching, RANSAC homography, grabCut, streaming decode, optical flow, template matching, WebP lossy encoding |
...
601 public APIs by category. See [docs/features.md](docs/features.md) for overview and [docs/api_reference.md](docs/api_reference.md) for full signatures.

## 🎯 Multi-Target Support

| Target | Backend | Tests | Status |
|:------:|:-------:|:-----:|:------:|
| **native** | Pure MoonBit | 1611 | ✅ |
| **wasm-gc** | Pure MoonBit | 1611 | ✅ |
| **js** | Pure MoonBit | 1611 | ✅ |
| **wasm** | Pure MoonBit | 1611 | ✅ |
...
| [docs/api_reference.md](docs/api_reference.md) | Full API reference (601 functions + 1 const + 47 types) |
...
| [docs/features.md](docs/features.md) | Feature overview (601 APIs by category) |

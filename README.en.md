...
| | 🟢 | **553 APIs** | From basic I/O to FFT, Canny, watershed, SLIC, ORB, SIFT, SIFT matching, RANSAC homography, grabCut, streaming decode, optical flow, template matching, WebP lossy encoding |
...
553 public APIs by category. See [docs/features.md](docs/features.md) for overview and [docs/api_reference.md](docs/api_reference.md) for full signatures.

## 🎯 Multi-Target Support

| Target | Backend | Tests | Status |
|:------:|:-------:|:-----:|:------:|
| **native** | Pure MoonBit | 1583 | ✅ |
| **wasm-gc** | Pure MoonBit | 1583 | ✅ |
| **js** | Pure MoonBit | 1583 | ✅ |
| **wasm** | Pure MoonBit | 1583 | ✅ |
...
| [docs/api_reference.md](docs/api_reference.md) | Full API reference (553 functions + 1 const + 47 types) |
...
| [docs/features.md](docs/features.md) | Feature overview (553 APIs by category) |

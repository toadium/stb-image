...
- **多目标支持**：native/wasm-gc/js/wasm 全目标通过 1003 测试
- **完整图像处理**：resize/crop/rotate/draw/滤波/色彩/分割/频域/ORB/SIFT/SIFT匹配/RANSAC/grabCut/光流/模板匹配等 279 公开函数

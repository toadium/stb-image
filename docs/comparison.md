...
| 库 | 版本 | 实现方式 | 目标 | 依赖 | 许可证 |
|---|---|---|---|---|---|
| **walkzzz/image** | 0.4.9 | 纯 MoonBit | native/wasm-gc/js/wasm | 无 | MIT |
...
| 库 | 测试数 | 特殊验证 |
|---|---|---|
| image | 1177×4 | 纯 MoonBit, 多目标, fuzzing审计 |
| mizchi/image | ? | ? |
...
- **多目标支持**：native/wasm-gc/js/wasm 全目标通过 1177 测试
...
| 零依赖 | shunge/image |
| WebP/AVIF 编码 | image (WebP lossy), mizchi/image (WebP lossless) |

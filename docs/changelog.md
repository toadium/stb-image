...
## v133.0.0 - 生产级增强：ocr模块 document_enhance（3个核心函数）
- 增强 ocr/document_enhance.mbt：3个核心函数补充完整的生产级验证
  - document_enhance：尺寸>0、通道数1-4、数据大小匹配（改为raise类型）
...
## v144.0.0 - 生产级增强：ocr模块 chinese_ocr_enhanced（2个核心函数）
- 增强 ocr/chinese_ocr_enhanced.mbt：2个核心函数补充完整的生产级验证
...
## v146.0.0 - 生产级增强：ocr模块 handwriting_ocr_enhanced（2个核心函数）
- 增强 ocr/handwriting_ocr_enhanced.mbt：2个核心函数补充完整的生产级验证
...
## v151.0.0 - 生产级增强：color模块 adaptive_threshold（3个核心函数）
- 增强 color/adaptive_threshold.mbt：3个核心函数补充完整的生产级验证
...
## v159.0.0 - 生产级增强：color模块 retinex_16f（2个核心函数）
...
## v172.0.0 - 生产级增强：color模块 adaptive_threshold_16f（1个核心函数）
- 增强 color/adaptive_threshold_16f.mbt：1个核心函数补充完整的生产级验证
  - adaptive_threshold_gaussian_16：补充尺寸>0、数据大小匹配验证（已有raise类型）

## v173.0.0 - 生产级增强：color模块 color_16f（2个核心函数）
- 增强 color/color_16f.mbt：2个核心函数补充完整的生产级验证
...
## v180.0.0 - 生产级增强：color模块 color_convert_16f（2个核心函数）
- 增强 color/color_convert_16f.mbt：2个核心float图像级函数补充完整的生产级验证
  - to_rgb_f：尺寸>0、通道数1-4、数据大小匹配（改为raise类型）
  - to_rgba_f：尺寸>0、通道数1-4、数据大小匹配（改为raise类型）
- 同步更新 reexport.mbt 中的2个函数类型定义（添加raise @types.LoadError）
...
## v183.0.0 - 生产级增强：color模块 quantize_16f（2个核心函数）
- 增强 color/quantize_16f.mbt：2个核心float函数补充完整的生产级验证

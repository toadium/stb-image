...
> 制定日期：2026-08-06 | 最后更新：2026-08-13 | 当前版本：v4.10.0 | 测试：1196×4 | 覆盖率：90.4%
...
| **v4.9.0** | **诚实性修复：流式解码文档修正 + WebP格式表修正 + reexport注释修正** | **1177×4** | **287** | **✅ 已完成** |
| **v4.10.0** | **安全加固：check_dims维度守卫 + safe_mul溢出保护 + 全解码器入口校验 + 24项安全测试 + 魔法数字清理 + 15项高级算法基准** | **1196×4** | **291** | **✅ 已完成** |
...
- **光流 (Farneback)**：视频领域，纯图像库不做（Lucas-Kanade 稀疏光流已在 v4.3 实现）

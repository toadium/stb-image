...
| | 🟢 | **607 个 API** | 从基础 I/O 到 FFT、Canny、分水岭、SLIC、ORB、SIFT、SIFT 匹配、RANSAC 单应性、grabCut、流式解码、光流、模板匹配、WebP lossy 编码等高级算法 |
...
607 个公开 API 按分类概览，详见 [docs/features.md](docs/features.md)。完整签名见 [docs/api_reference.md](docs/api_reference.md)。

## 🎯 多目标支持

| 目标 | 后端 | 测试 | 状态 |
|:----:|:----:|:----:|:----:|
| **native** | 纯 MoonBit | 1619 | ✅ |
| **wasm-gc** | 纯 MoonBit | 1619 | ✅ |
| **js** | 纯 MoonBit | 1619 | ✅ |
| **wasm** | 纯 MoonBit | 1619 | ✅ |
...
| [docs/api_reference.md](docs/api_reference.md) | 完整 API 参考（607 函数 + 1 常量 + 47 类型） |
...
| [docs/features.md](docs/features.md) | 功能一览（607 API 分类概览） |
